...
import { DIOPayload, AIPayload, AOPayload, EncoderPayload, PWMPayload, RelayPayload, DriverStationPayload, RoboRioPayload, JoystickPayload } from "./wpilib-ws-proto-messages";
